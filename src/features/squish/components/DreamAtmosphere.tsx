...
export function DreamAtmosphere() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden rounded-[45%]">
      <div className="absolute inset-x-[12%] top-[12%] h-[68%] rounded-full bg-mist/10 blur-3xl" />
      <div className="absolute top-[10%] left-[15%] h-[38%] w-[48%] rounded-full bg-blush/10 blur-3xl" />
      <div className="absolute right-[10%] bottom-[10%] h-[42%] w-[55%] rounded-full bg-pollen/10 blur-3xl" />
